...
export default async function Nav({ isAdminPage }) {
  ...
  return (
    <header className="shadow-shad fixed top-0 right-0 left-0 z-50 bg-white px-6 md:px-12 py-4 md:py-6 grid grid-cols-3 md:flex md:items-center md:justify-between">
