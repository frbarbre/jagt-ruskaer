...
export default function NewArticles() {
    ...
    const mockArticles = [
        {
            ...
            description: 'Skal du til haglskydeprøve - se her for at få en fornemmelse.'
        },
        {
            ...
            description: 'Husk at indsamle haler/fødder fra råvildt til foreningens konkurrence.'
        },
        {
            category: 'Galleri',
            icon: <Image />,
            ...
            description: 'Se billederne af disse prægtige og ikke mindst, nu, utætte klovdyr.'
        },
    ]
    ...
    return (
        <Box className="w-full flex flex-col gap-3 pb-1 overflow-auto px-0 lg:max-w-[890px]">
            <div className='px-5'>
